...
<html>
	<head>
		...
		<title>Plank Employee Registration</title>
	</head>
	<body>
		<h2>Add Plank Employee Data</h2>
		<form:form method="POST" action="/sdnext/save.html">
	   		<table>
			    ...
			    <tr>
			        <td><form:label path="pwd">Employee Password:</form:label></td>
			        <td><form:input path="pwd" value="${employee.pwd}" type = "password"/></td>
			    </tr>
			    <tr>
	...
	<table align="left" border="1">
		...
		<c:forEach items="${employees}" var="employee">
			<tr>
				...
				<td><c:out value="${employee.pwd}"/></td>
				<td><c:out value="${employee.age}"/></td>
				<td><c:out value="${employee.salary}"/></td>
				<td><c:out value="${employee.address}"/></td>
				<td align="center">
				<a href="edit.html?id=${employee.id}">Edit</a> | <a href="delete.html?id=${employee.id}">Delete</a></td>
			</tr>
		</c:forEach>
	</table>
	</c:if> 
...
<h2><a href = "loginlink.html" >Login for XPlank Employee</a></h2>
</center>
</body>
</html>